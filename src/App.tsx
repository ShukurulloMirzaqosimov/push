...
//   const [currentSong, setCurrentSong] = useState<CurrentSongProps>(songs[currentSongIndex]);
//   const [playBtn, setPlayBtn] = useState(true);
//   const [showSongs, setShowSongs] = useState(true);
//   const [songInfo, setSongInfo] = useState<{ current: number; duration: number }>({
//     current: 0,
//     duration: 0,
//   });
...
//     const newIndex = (currentSongIndex + step + songs.length) % songs.length;
...
//         )}
//       </nav>
//       <div className="flex h-[calc(100vh-4rem)]" style={{ transition: "all 0.5s" }}>
//         <div
//           className={`overflow-y-auto ${showSongs ? "w-1/5" : "w-0"}`}
...
//         </div>
//         <div
//           className={`music bg-red-600 flex text-white flex-col justify-center items-center ${
...
//             <CgPlayTrackPrev onClick={() => nextSong(-1)} className="cursor-pointer" />
//             {playBtn ? (
//               <IoIosPlay onClick={playSong} className="cursor-pointer" />
//             ) : (
//               <CgPlayPause onClick={playSong} className="cursor-pointer" />
//             )}
//             <CgPlayTrackNext onClick={() => nextSong(1)} className="cursor-pointer" />
//           </div>
//           <audio
